...
test: test-go test-alipay-beancount test-alipay-ledger test-wechat-beancount test-wechat-ledger test-huobi-beancount test-huobi-ledger test-htsec-beancount test-htsec-ledger test-icbc-beancount test-icbc-ledger test-ccb-beancount test-ccb-ledger test-td-beancount test-td-ledger test-bmo-beancount test-bmo-ledger test-citic-beancount test-citic-ledger test-hsbchk-beancount test-hsbchk-ledger test-jd-beancount test-jd-ledger test-mt-beancount test-hxsec-beancount test-cmb-beancount test-cmb-ledger test-abcdebit-beancount test-abcdebit-ledger ## Run all tests
...
test-abcdebit-beancount: ## Run tests for abc debit provider against beancount compiler
	@$(SHELL) ./test/abcdebit-test-beancount.sh
test-abcdebit-ledger: ## Run tests for abc debit provider against ledger compiler
	@$(SHELL) ./test/abcdebit-test-ledger.sh
