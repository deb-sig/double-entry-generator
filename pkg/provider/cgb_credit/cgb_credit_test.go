...
2025/01/05,2025/01/06,（消费）美团支付-美团App,15.90,人民币,15.90,人民币
2025/01/04,2025/01/04,（退款）京东支付-金蟾官方旗舰店,-97.20,人民币,-97.20,人民币
2025/01/03,2025/01/03,（分期）银联分期24093953599/10/12期,387.42,人民币,387.42,人民币
2024/12/25,2024/12/26,（还款）云闪付 银联入账-王明阳,-1130.68,人民币,-1130.68,人民币
`
	...
	tests := []struct {
		...
		{0, ir.TypeSend, 15.90, "CNY", "（消费）美团支付-美团App", "2025-01-05", "2025-01-06"},
		{1, ir.TypeRecv, 97.20, "CNY", "（退款）京东支付-金蟾官方旗舰店", "2025-01-04", "2025-01-04"},
		{2, ir.TypeSend, 387.42, "CNY", "（分期）银联分期24093953599/10/12期", "2025-01-03", "2025-01-03"},
		{3, ir.TypeRecv, 1130.68, "CNY", "（还款）云闪付 银联入账-王明阳", "2024-12-25", "2024-12-26"},
	}
